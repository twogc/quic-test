# 2GC Network Protocol Suite - Multi-stage Dockerfile
...
LABEL org.opencontainers.image.title="2GC Network Protocol Suite"
LABEL org.opencontainers.image.description="Comprehensive network protocol testing platform for QUIC, MASQUE, ICE/STUN/TURN"
