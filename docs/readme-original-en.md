...
- **Russian:** [readme.md](readme.md) - Русская документация и методические материалы
...
For detailed Russian language documentation with lab materials and teaching guidelines, see [readme.md](readme.md).
