...
func NewPrometheusMetrics(reg prometheus.Registerer) *PrometheusMetrics {
	...
	return &PrometheusMetrics{
		...
		// RTT метрики
		RTTMinMs: factory.NewGauge(prometheus.GaugeOpts{
			Name: "quic_rtt_min_ms",
			Help: "Minimum RTT in milliseconds",
		}),
		RTTMaxMs: factory.NewGauge(prometheus.GaugeOpts{
			Name: "quic_rtt_max_ms",
			Help: "Maximum RTT in milliseconds",
		}),
		RTTMeanMs: factory.NewGauge(prometheus.GaugeOpts{
			Name: "quic_rtt_mean_ms",
			Help: "Mean RTT in milliseconds",
		}),
		RTTPercentile95Ms: factory.NewGauge(prometheus.GaugeOpts{
		...
		GoodputBps: factory.NewGauge(prometheus.GaugeOpts{
